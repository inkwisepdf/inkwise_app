...
class AISummarizerService {
  ...
  double _calculateInverseDocumentFrequency(
      String word, List<String> sentences) {
  ...
  String _generateCoherentSummary(
      List<String> selectedSentences, String language) {
